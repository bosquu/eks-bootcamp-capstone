...
export declare function isCodeCommitRepo(repo: GitHubSourceRepository | CodeCommitSourceRepository): boolean;
/**
...
export declare class CodePipelineBuilder implements StackBuilder {
    ...
    repository(repo: GitHubSourceRepository | CodeCommitSourceRepository): CodePipelineBuilder;
    /**
